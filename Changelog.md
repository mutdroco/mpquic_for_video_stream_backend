...
- Changed the log level environment variable to only accept strings ("DEBUG", "INFO", "ERROR"), see [the wiki](https://github.com/mutdroco/mpquic_nonml_for_video_stream_backend/wiki/Logging) for more details.
